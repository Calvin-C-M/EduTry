...
const MyTryoutCard = ({ tanggal, deadline, nama, tim, href }) => {
    ...
    return (
        <div className='flex w-full h-full items-center bg-blue-dark'>
            <div className='flex-none w-[30%] min-h-[12vh] bg-blue-light m-5 py-3 md:py-6 px-2'>
                <span className='flex justify-center font-bold text-4xl md:text-6xl text-primary'>{splitTanggal()[2]}</span>
                <span className='flex justify-center text-center font-medium text-sm md:text-lg text-primary pt-2'>{splitTanggal()[1]} {splitTanggal()[0]}</span>
            </div>
