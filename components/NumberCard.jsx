const NumberCard = ({ data, index, handleClick }) => {
  return (
    <div className='w-full p-5 bg-white rounded-lg shadow-md my-4'>
        ...
        <button onClick={''} className='w-full h-fit bg-primary font-bold text-white text-center p-3 mt-2 rounded-lg'>Submit Jawaban</button>
    </div>
  )
}
