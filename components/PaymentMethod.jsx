    ...
    <div className='w-full bg-white p-2 md:p-5 rounded-lg shadow-md'>
        ...
        {wallet ? (
            <div className='w-full'>
                <div className='flex justify-between items-center h-10 p-2 border-b-2 border-black'>
                    <label className='grid grid-cols-2 place-items-center w-3/5 gap-6 text-base md:text-lg font-bold text-black'>
                        <Image src='https://gopay.co.id/_nuxt/img/site-logo.3e08530v120.png' alt='Gopay Logo' className='h-4/5' />
                ...
                <div className='flex justify-between items-center h-10 p-2 border-b-2 border-black'>
                    <label className='grid grid-cols-2 place-items-center w-3/5 gap-6 text-base md:text-lg font-bold text-black'>
                        <Image src='https://upload.wikimedia.org/wikipedia/commons/thumb/e/eb/Logo_ovo_purple.svg/512px-Logo_ovo_purple.svg.png' alt='OVO Logo' className='h-4/5' />
                ...
                <div className='flex justify-between items-center h-10 p-2 mb-4 border-b-2 border-black'>
                    <label className='grid grid-cols-2 place-items-center w-3/5 gap-6 text-base md:text-lg font-bold text-black'>
                        <Image src='https://shopeepay.co.id/src/pages/home/assets/images/2-shopeepay-rectangle-orange2.png' alt='ShopeePay Logo' className='h-4/5' />
        ...
        {bank ? (
            <div className='w-full'>
                <div className='flex justify-between items-center h-10 p-2 border-b-2 border-black'>
                    <label className='grid grid-cols-2 place-items-center w-3/5 gap-6 text-base md:text-lg font-bold text-black'>
                        <Image src='https://bankmandiri.co.id/image/layout_set_logo?img_id=31567&t=1683824600225' alt='Mandiri Logo' className='h-4/5' />
                ...
                <div className='flex justify-between items-center h-10 p-2 border-b-2 border-black'>
                    <label className='grid grid-cols-2 place-items-center w-3/5 gap-6 text-base md:text-lg font-bold text-black'>
                        <Image src='https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Bank_Central_Asia.svg/799px-Bank_Central_Asia.svg.png' alt='BCA Logo' className='h-4/5' />
                ...
                <div className='flex justify-between items-center h-10 p-2 border-b-2 border-black'>
                    <label className='grid grid-cols-2 place-items-center w-3/5 gap-6 text-base md:text-lg font-bold text-black'>
                        <Image src='https://upload.wikimedia.org/wikipedia/id/thumb/5/55/BNI_logo.svg/175px-BNI_logo.svg.png?20131101150556' alt='BNI Logo' className='h-4/5' />
                ...
                <div className='flex justify-between items-center h-10 p-2 mb-4 border-b-2 border-black'>
                    <label className='grid grid-cols-2 place-items-center w-3/5 gap-6 text-base md:text-lg font-bold text-black'>
                        <Image src='https://bri.co.id/o/bri-corporate-theme/images/bri-logo.png' alt='BRI Logo' className='h-4/5' />
