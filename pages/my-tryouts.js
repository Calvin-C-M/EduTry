...
export default function MyTryouts() {
  ...
  const myTryoutsDone = [
    {id:2, nama:'Tryout UTBK #2', tanggal:'27', bulan:'Februari', tahun:2023, deadline:'01/03/2023', tim:'Edutry Team', href:''},
  ]

  const [status, setStatus] = useState(true)

  return (
    <div className='w-full min-h-screen px-10 md:px-28 pt-36 pb-20'>
